...
public:
	...
	double  RThreadshold;//边界保留参数
	double  BAngleThreshold;//边界保留角度阈值
	double m_clusterDistance;//最小聚类距离
...
public://操作
	...
	pcl::PointCloud<pcl::PointXYZ>::Ptr cloud; // PCL 点云存储空间   zcl加
	...
	void BoundaryClustering(pcl::PointCloud<pcl::PointXYZ>::Ptr boundarycloud);//边界聚类
